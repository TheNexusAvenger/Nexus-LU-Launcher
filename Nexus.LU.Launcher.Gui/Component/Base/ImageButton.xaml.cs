...
public class ImageButton : Image
{
    ...
    /// </summary>
    public static readonly RoutedEvent<RoutedEventArgs> ButtonPressedEvent = RoutedEvent.Register<InputElement, RoutedEventArgs>(nameof(PointerEnteredEvent), RoutingStrategies.Direct);
    ...
    private void UpdateSource()
    {
        ...
        if (source == "") return;
        this.Source = new Bitmap(AssetLoader.Open(new Uri($"avares://{Assembly.GetEntryAssembly()?.GetName().Name}{source}")));
    }
}