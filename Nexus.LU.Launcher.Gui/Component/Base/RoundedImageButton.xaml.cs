...
public class RoundedImageButton : Border
{
    ...
    /// </summary>
    public static readonly RoutedEvent<RoutedEventArgs> ButtonPressedEvent = RoutedEvent.Register<InputElement, RoutedEventArgs>(nameof(PointerEntered), RoutingStrategies.Direct);
    ...
    public RoundedImageButton()
    {
        ...
        {
            if (args.Property != BaseSourceProperty && args.Property != HoverSourceProperty && args.Property != PressSourceProperty && args.Property != ActiveProperty) return;
            this.UpdateSource();
            this.UpdateColors();
        };
    ...
    public void UpdateSource()
    {
        ...
        if (source == "") return;
        this.Get<Image>("Image").Source = new Bitmap(AssetLoader.Open(new Uri($"avares://{Assembly.GetEntryAssembly()?.GetName().Name}{source}")));
    }
